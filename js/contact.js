...
async function handleFormSubmit(event) {
    ...
    try {
        ...
        // ⬇️⬇️⬇️ AJOUT ICI - Sauvegarder en base de données ⬇️⬇️⬇️
        console.log('🟢 Tentative de sauvegarde en base...', formData);
        const saved = await saveContactToDatabase(formData);
